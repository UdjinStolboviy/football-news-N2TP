...
container
  .bind<InitializationService>(Types.InitializationService)
  .to(InitializationService);
container
  .bind<InitializationStorage>(Types.InitializationStorage)
  .to(InitializationStorage)
  .inSingletonScope();
container
  .bind<NavigationStorage>(Types.NavigationStorage)
  .to(NavigationStorage)
  .inSingletonScope();
container
  .bind<SystemModalsStorage>(Types.SystemModalsStorage)
  .to(SystemModalsStorage)
  .inSingletonScope();
container.bind<Navigator>(Types.Navigator).to(Navigator).inSingletonScope();
container
  .bind<NewsStorage>(Types.NewsStorage)
  .to(NewsStorage)
  .inSingletonScope();
container
  .bind<BestPlayersStorage>(Types.BestPlayersStorage)
  .to(BestPlayersStorage)
  .inSingletonScope();
container
  .bind<GameStorage>(Types.GameStorage)
  .to(GameStorage)
  .inSingletonScope();
container
  .bind<LineupsStorage>(Types.LineupsStorage)
  .to(LineupsStorage)
  .inSingletonScope();
